	...
	*/
	...
	export enum WrapMode {		
		...
		*/
		...
		``` 
		*/
		schedule(callback : Function, target : any, interval : number, repeat : number, delay : number, paused : boolean, key : number) : void;		
		/** <p>
	...
	export enum UIOrientation {		
		...
		*/
		...
		@param rect if parameters' length equal 2, rect in points, else rect in pixels 
		*/
		create(filename : string|Texture2D, rect : Rect, rotated : boolean, offset : Vec2, originalSize : Size) : SpriteFrame;		
